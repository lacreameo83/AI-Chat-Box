...
function SideBarItems({ primary, icon, icon2 }) {
  ...
  return (
    <div className=" my-2 text-[13px]   font-[500] justify-between  flex items-center  ">
      <div className="flex text-base opacity-[40%] text-[#718096] h-[25px] items-center gap-2">
        {icon ? <p> {icon} </p> : <p className="pl-4 "></p>}

        <p className="text-[13px]">{primary}</p>
      </div>
